class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    devise_paramater_sanitizer.permit(:sign_up, keys: [:name, :email, :password])
    devise_paramater_sanitizer.permit(:account_update, keys: :name, :email, :password, :current_password)
  end
end
